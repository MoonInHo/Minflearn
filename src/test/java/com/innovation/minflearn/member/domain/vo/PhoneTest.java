...
class PhoneTest {
    ...
    @ParameterizedTest
    @ValueSource(strings = {"01012345678", "010.1234.5678", " 010-1234-5678", "02-1234-5678"})
    @DisplayName("연락처 입력 - 올바르지 않은 형식의 연락처 입력시 예외 발생")
    ...
    @ParameterizedTest
    @ValueSource(strings = {"010-1234-5678", "010-5555-4444", "010-5234-1234"})
    @DisplayName("연락처 입력 - 올바른 형식의 연락처 입력시 연락처 객체 반환")
    void properFormatPhone_returnPhoneObject(String phone) {
        //given & when
